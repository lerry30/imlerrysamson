...
const pageTop = Math.abs(sessionStorage.getItem('page-top')) - (innerHeight * 0.2) || 0; // subtract 20% since this loading container or background has 140vh of height to prevent displaying the behind from unexpected pushing downward of this loading container
